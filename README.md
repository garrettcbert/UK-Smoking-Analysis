...
Final Project Jupyter Notebook HTML: <a href=https://github.com/garrettcbert/UK-Smoking-Analysis/blob/ebcf4f16fd54697bffefd21c890092b422fc86f3/final_UK_Smoking.html>UK-Smoking-Analysis</a>
...
Thinking about this from a different perspective, the reason that Married people carry a lower percentage of smokers is because they have someone to lean on; someone to push them to form good habits. With this in mind, a proper solution could just be to push people to form any type of relationship. Connections in all shapes and sizes are great for forming the best versions of ourselves. Admittedly, peer pressure can play a nasty role in the formation of bad habits but healthy relationships are everywhere. So, encourage people to get outside and form connections!

### `Basic Education`
The base of this difference has less to do with the education itself, and likely more to do with the pressure to form these bad habits in a place like secondary school. Encouraging a lifestyle and educating students about the risks of smoking is beneficial, but at the end of the day, schools need to foster a positive environment where students are less likely to turn to smoking in the first place. To me, this means having meaningful clubs and available sports, as well as providing opportunities and help for the less fortunate.

Ultimately, limiting access to cigarettes and vapes would do everyone good, but this is simply not possible. If we want to lower the percentage of people who smoke, we need to raise the percentage of people who live a happy enough life that they have no reason to take up a bad habit.
